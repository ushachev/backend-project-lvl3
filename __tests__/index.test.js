...
import { loadAssetsInSilentMode, loadAssetsInVisualMode } from '../src/loadAssets.js';
...
describe.each([
  ['silent', loadAssetsInSilentMode],
  ['visual', loadAssetsInVisualMode],
])('with %s assets loader', (_mode, loadAssets) => {
  const loadPage = getPageLoader(loadAssets);
